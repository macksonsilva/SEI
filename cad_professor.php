<?php $pagina = 'Cadastro de Professor'; 
              ...
              <div class="x_content">
                ...
                <?php
                  ...
                  <?php
                        ...
                        input('text', 'Nome', 'col-md-12 col-sm-12 col-xs-12 form-group');
                        input('text', 'Login', 'col-md-6 col-sm-12 col-xs-12 form-group');
                        input('text', 'Senha', 'col-md-6 col-sm-12 col-xs-12 form-group');
                        input('text', 'Fone', 'col-md-6 col-sm-12 col-xs-12 form-group');
                        selectPermissao('select', 'Permissao', 'col-md-6 col-sm-12 col-xs-12 form-group');
